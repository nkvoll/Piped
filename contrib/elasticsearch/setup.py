...
import piped.contrib.elasticsearch

setup(
    name = 'piped.contrib.elasticsearch',
    license = 'MIT',
    ...
    version = str(piped.contrib.elasticsearch.version),
    classifiers = [
    ...
    description = 'ElasticSearch support for Piped.',
