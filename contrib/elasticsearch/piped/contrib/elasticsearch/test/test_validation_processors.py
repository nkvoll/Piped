...
from piped.contrib.elasticsearch import processors
...
class TestFormEncodeelasticsearch(unittest.TestCase):
    ...
    def test_processor_invokes_the_schema(self):
        ...
        # about the elasticsearch here, since we're not unittesting
        # FormEncode.
