...
import piped.contrib.autocompletion

setup(
    name = 'piped.contrib.autocompletion',
    license = 'MIT',
    ...
    version = str(piped.contrib.autocompletion.version),
    classifiers = [
    ...
    description = 'Ranked autocompletion using mmapped suffix-arrays and segment trees.',
